...
const Modal = ({id, title, content, onCancel, onSubmit, type, cancelClassname, submitClassname, cancelButtonText, submitButtonText}) => {
  ...
  const getCancelButtonText = (type) => {
    switch(type){
      ...
      case "custom" : return `Batal`;
      case "confirm" : return `Batal`;
  ...
  const cancelText = cancelButtonText ? cancelButtonText : getCancelButtonText(type);
  const submitText = submitButtonText ? submitButtonText : getSubmitButtonText(type);
  return ( 
